...
const quizQuestions = [
    {
        q: "What is the thing you value most in life?",
        a: [
    ...
    {
        q: "What do you usually do during the weekend?",
        a: [
    ...
    {
        q: "When you encounter a problem, how do you solve that problem?",
        a: [
    ...
    {
        q: "Which of these do you think is your style?",
        a: [
    ...
    {
        q: "What kind of environment do you like?",
        a: [
    ...
    {
        q: "After a long day, how do you recharge yourself?",
        a: [
    ...
    {
        q: "If you were given the option to take a brief vacation, how would you choose to spend it??",
        a: [
    ...
    {
        q: "People would describe you at work or school as..?",
        a: [
    ...
    {
        q: "Which of these you resonate with the most?",
        a: [
    ...
    {
        q: "Your ideal work position would entail?",
        a: [
